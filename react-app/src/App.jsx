...
/*   Updated: 2024/01/07 13:49:27 by jmykkane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
function App() {
  ...
  return (
    <div class='min-w-screen min-h-screen bg-gray-900 flex items-center justify-center'>
      <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl flex justify-center w-[95vw] h-[90vh] overflow-hidden">

        <div class="hidden md:block bg-indigo-500 md:w-1/2 h-full">
    ...
    //     <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl flex flex-col justify-center w-full h-full overflow-hidden">
    //       <div class="md:flex w-full">

    //         <div class="hidden md:block bg-indigo-500 w-1/2 py-10 px-10">
    ...
    //         <div class="h-full md:w-1/2 py-10 px-10 md:px-10">
