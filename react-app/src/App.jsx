...
/*   Updated: 2024/01/11 15:57:15 by jmykkane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
function App() {
  ...
  return (
    <div className='min-w-screen min-h-screen flex items-center justify-center gradient-animated'>
      <div className='h-full flex flex-col lg:flex-row bg-secondary-100 text-gray-500 rounded-3xl shadow-xl justify-center lg:w-[90vw] lg:h-[90vh] overflow-auto lg:overflow-hidden'>

        {/* LEFT SIDE OF THE APP HAS THE INFO AND SELLING POINTS */}
        <div className='relative w-full h-[100dvh] bg-primary-100 lg:w-1/2 lg:h-full z-0'>
          ...
          <div className='absolute bottom-0 mb-3 w-full h-[32px] flex flex-col items-center'>
            <div className='px-3 h-full bg-bar rounded-2xl flex flex-row items-center justify-center'>
              <div className='rounded-xl flex flex-row items-center justify-center'>
                <div className='bg-dark w-3 h-3 rounded-xl'/>
                <div className='bg-dark w-3 h-3 rounded-xl mx-2'/>
                <div className='bg-dark w-3 h-3 rounded-xl'/>
              </div>
            </div>
          </div>
